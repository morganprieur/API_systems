...
### In order to use 'manager_group': put here the bloc stored in : 
# C:\Users\mprieur\Documents\PROJETS_BE\Projet_BEI\CODE\bei\setup_api\api\dashboard\utils\manager_group_permission.py 
